                    ...
                    GestureDetector(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          menu ? const Text("Menu", style: TextStyle(color: AppColor.orange)) : const Text("Menu"),
                        ],
                      ),
                    ),
                    GestureDetector(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          offer ? const Text("Offers", style: TextStyle(color: AppColor.orange)) : const Text("Offers"),
                        ],
                      ),
                    ),
                    const SizedBox(
                    ...
                    GestureDetector(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          profile ? const Text("Profile", style: TextStyle(color: AppColor.orange)) : const Text("Profile"),
                        ],
                      ),
                    ),
                    GestureDetector(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          more ? const Text("Profile", style: TextStyle(color: AppColor.orange)) : const Text("More"),
                        ],
                      ),
                    ),
                  ],
