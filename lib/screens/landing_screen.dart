...
class CustomClipperAppBar extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    Offset controlPoint2 = Offset(size.width * 0.3, size.height * 0.72);
    Offset endPoint2 = Offset(size.width * 0.5, size.height * 0.72);
    Offset controlPoint3 = Offset(size.width * 0.7, size.height * 0.72);
